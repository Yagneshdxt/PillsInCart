<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.master" AutoEventWireup="true"
    CodeFile="PaymentDetialsVisibility.aspx.cs" Inherits="Admin_PaymentDetialsVisibility" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <center>
        <asp:SqlDataSource ID="dsAdmin" runat="server" ConnectionString="<%$ ConnectionStrings:myConnectionString %>"
            SelectCommand="select gconstantid,typename,description,modifieddate,activeflag from mstGeneralCnst where typename = 'Payment Details'">
        </asp:SqlDataSource>
