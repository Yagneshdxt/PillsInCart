<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.master" AutoEventWireup="true"
    CodeFile="ProdEdit.aspx.cs" ValidateRequest="false" EnableEventValidation="false"
    EnableViewStateMac="false" Inherits="Admin_ProdEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        //        function InitTiny() { tinyMCE.execCommand('mceAddControl', false, 'MainContent_txtProdDescription'); }
            ...
            tinyMCE.init({
                ...
                setup: function (ed) {
                    ed.onChange.add(function (ed, l) {
                        $('[id*=hdnProdDes]').val(l.content);
                    });
                    ed.onSetContent.add(function (ed, o) {
                        // Replaces all a characters with b characters
                        $('[id*=hdnProdDes]').val(o.content);
    ...
    <table border="0" cellpadding="5" cellspacing="5">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:LinkButton Text="View" href="#" ID="lnkUpLogo" class="lightbox" Style="margin-left: 100px;"
                    runat="server" />
                <div class="box">
                    <div class="close">
                        x</div>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:LinkButton Text="View" href="#" ID="lnkUpAdver" class="lightbox" Style="margin-left: 100px;"
                    runat="server" />
                <div class="box">
                    <div class="close">
                        x</div>
    ...
    <fieldset>
        ...
        <asp:UpdatePanel ID="UpAddMetaTag" runat="server">
            <ContentTemplate>
                <table id="tblAddMetaTag" width="100%" border="0">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator21" ErrorMessage="Please enter Name"
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator22" ErrorMessage="Please enter Content"
                                ControlToValidate="txtMetaContent" Display="Dynamic" Text="*" ValidationGroup="addMetachk"
                                runat="server" ForeColor="Red" />
                        </td>
                        <td>
                            <asp:Button Text="Update" runat="server" CausesValidation="true" ValidationGroup="addMetachk"
                                ID="btnUpdateMetaTag" OnClick="btnUpdateMetaTag_Click" />
                ...
                <p>
                    &nbsp;
                    <asp:UpdateProgress ID="UpProAddMetaTag" AssociatedUpdatePanelID="UpAddMetaTag" runat="server">
                        <ProgressTemplate>
                            <div>
                                Loading ......
                            </div>
    ...
    <fieldset>
        ...
        <asp:UpdatePanel ID="upPnlProDes" runat="server">
            <ContentTemplate>
                ...
                <asp:UpdateProgress ID="upProProDes" AssociatedUpdatePanelID="upPnlProDes" runat="server">
                    <ProgressTemplate>
                        <div>
                            Loading ......
                        </div>
                ...
                <asp:GridView ID="grdProdDes" runat="server" AutoGenerateColumns="False" PageSize="10"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Description">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtProdDescription" runat="server" TextMode="MultiLine" Width="400px"
                                    CssClass="gridTxtEditor" Rows="15" Text='<%# HttpUtility.HtmlDecode(Eval("prodDescription").ToString()) %>'></asp:TextBox>
                                    <asp:HiddenField ID="hdnProdDes" runat="server" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator20" ErrorMessage="Please enter Descriptoin"
                                    ControlToValidate="txtProdDescription" Display="Dynamic" ValidationGroup="valProductDescription"
                                    runat="server" Text="*" ForeColor="Red" />
                            </EditItemTemplate>
