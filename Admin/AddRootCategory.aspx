<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.master" AutoEventWireup="true"
    CodeFile="AddRootCategory.aspx.cs" Inherits="Admin_AddRootCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table border="0" cellpadding="5" cellspacing="5">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtcategorydesc" TextMode="MultiLine" runat="server"></asp:TextBox>
    ...
    <asp:GridView ID="grdRootcat" runat="server" AutoGenerateColumns="false" PageSize="10"
        ...
        <Columns>
            <asp:TemplateField HeaderText="Root Category Name">
                <ItemTemplate>
                    <asp:Label ID="lblrootcatnmae" runat="server" Text='<%#Eval("CatName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Category Description">
                <ItemTemplate>
                    <asp:Label ID="lblcatedesc" runat="server" Text='<%#Eval("catDescription") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Edit">
                <ItemTemplate>
                    ...
                    <asp:LinkButton Text="Delete" ID="lnkDelete" runat="server" OnClick="lnkDelete_Click" OnClientClick="Javascript:return confirm('Do you want to delete?');"/>
                    <asp:HiddenField ID="hdnRootCategorID" Value='<%# Eval("RootCateoryId") %>' runat="server" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
