...
public partial class DynamicProductMaster : System.Web.UI.Page
{
    ...
    protected void gotopage_Click(object sender, EventArgs e)
    {
        ...
        if (linkbutton != null)
        {
            ...
            string Url = GetRouteUrl("ProductDisplay", new { ProductName = "" + linkbutton.CommandName.Trim().Replace(" ", "-") + "" });
